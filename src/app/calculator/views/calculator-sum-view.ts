...
@Component({
  template: `
    <h1>Calculadora que solo suma</h1>
...
export class CalculatorSumView implements IObserver, OnInit, OnDestroy {
  ...
  public sum() {
    this.result = this.controller.handleSum(this.inputNum1, this.inputNum2);
    this.cdRef.markForCheck();
  }
}
